...
| T-7 | Genealogy — reproduce precursor math per published standard (G-1…G-7, `scripts/genealogy/`) | **done 2026-09-02** — 6/7 reproducible, G-7 partially (channel-count ambiguity) | order.relations |
